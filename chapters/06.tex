...
Listing \ref{lst:tst-wyniki} zawiera wyniki wybranych testów jednostkowych.
...
\begin{itemize}
    \item Zapisywanie łańcucha znaków w pamięci podczas memoizacji.
    \item Kolejność wykonywania gałęzi \verb|elseif|.
    \item Brak wyrównania stosu oraz poprawnych ramek stosu. W początkowej fazie implementacji, a dokładniej w czasie prototypowania, stos nie był wyrównywany do 16 bajtów, co powodowało w niespodziewanych momentach błąd pamięci.
...
\begin{lstlisting}[caption={Test mechanizmu memoizacji}]
...
func main() int {
    ...
    PrintlnStr(Concat("drugie wywolanie (z safe): ", Itoa(t2)));
