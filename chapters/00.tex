...
Celem pracy jest zaprojektowanie i implementacja kompilatora języka programowania wzorowanego na języku C, szczególnie w zakresie składni oraz semantyki, który udostępnia programiście jawną kontrolę nad wykorzystaniem techniki optymalizacyjnej memoizacji. Mechanizm ten umożliwia zapamiętywanie wyników deterministyczych i kosztownych obliczeniowo funkcji już na etapie analizy semantycznej oraz generacji kodu asemblerowego. Zastosowanie memoizacji pozwala na optymalizację czasu wykonywania programu wynikowego kosztem zwiększonego zużycia pamięci.
